...
pub struct GameSettings {
    ...
    top_margin: f32,
    viewport_height: f32,
    game_area_x_transform: f32,
    game_area_y_transform: f32,
    game_area_x_max: f32,
    game_area_x_min: f32,
    game_area_y_max: f32,
    game_area_y_min: f32,
...
impl GameSettings {
    pub fn new(scale: f32, game_area_tile_x_max: f32, game_area_tile_y_max: f32, input_debounce: f32, tile_width: f32, tile_height: f32) -> Self {
        ...
        let game_area_x_transform: f32 = (game_area_x_res / 2.0) * -1.0 + (tile_width * scale / 2.0);
        ...
        let game_area_y_max: f32 = (game_area_y_res + game_area_y_transform) - (tile_height * scale);
